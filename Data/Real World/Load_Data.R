...
# Raster
# Warning: The following line could produce the error: '.hdf' not recognized as a supported file format.
# Therefore, you find the actual train and test set of the real-world application also as .txt file in the current folder
r <- raster(mf[1])
# Raster to data
